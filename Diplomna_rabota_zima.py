...
# Таблица - Average hourly profiles - Direct normal irradiation [kWh/m2] - типова крива за слънчевата радиация в хубав пролетно-летен (февруари) ден по нашите географски ширини
c_i_1 = 0
c_i_2 = 0
c_i_3 = 0
c_i_4 = 0
